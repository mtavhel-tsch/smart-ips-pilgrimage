...
//Product overview
  ...
  * item[=]
    ...
    * insert Question(operatingSystem, What operating systems does the Digital Health Solution work on, choice, true)
    * item[=].answerValueSet = Canonical(OperatingSystem)
    * insert Question(browser, What browsers does the Digital Health Solution work on (if applicable\)?, choice, true)
    ...
    * insert Question(language,Which languages are currently supported by the Digital Health Solution?	, choice,true)
